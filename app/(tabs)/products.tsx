  ...
  const subcategoriesByCategory: Record<string, Subcategory[]> = useMemo(
    ...
    { id: "machine-made", name: "Machine made", categoryId: "vases" },
      ...
      aroma: [
        ...
        { id: "refills", name: "Refills", categoryId: "aroma" },
        { id: "accessories", name: "Accessories", categoryId: "aroma" },
      ],
      candles: [
        { id: "all", name: "Alle artikelen", categoryId: "candles" },
        { id: "dinner", name: "Dinner", categoryId: "candles" },
        { id: "pillar", name: "Pillar", categoryId: "candles" },
        { id: "tealights", name: "Tea lights", categoryId: "candles" },
      ],
      "led-candles": [
        ...
        { id: "tea", name: "Tea lights", categoryId: "led-candles" },
      ],
      "gift-box": [
