...
const [offlineProductsInfo, setOfflineProductsInfo] = useState<{
  ...
  { id: "tree", name: "Tree", categoryId: "candles" },
      ...
      "led-candles": [
  { id: "new", name: "New", categoryId: "led-candle" },
  { id: "all", name: "Alle artikelen", categoryId: "led-candle" },
  { id: "cannelure", name: "Cannelure", categoryId: "led-candle" },
  { id: "wood", name: "Wood", categoryId: "led-candle" },
  { id: "tracy", name: "Tracy", categoryId: "led-candle" },
  { id: "wax-shape", name: "Wax shape", categoryId: "led-candle" },
  { id: "pillar", name: "Pillar", categoryId: "led-candle" },
  { id: "pencil", name: "Pencil", categoryId: "led-candle" },
  { id: "honeycomb", name: "Honeycomb", categoryId: "led-candle" },
  { id: "dinner", name: "Dinner", categoryId: "led-candle" },
  { id: "floating", name: "Floating", categoryId: "led-candle" },
  { id: "oil-lamp", name: "Oil lamp", categoryId: "led-candle" },
  { id: "chargeable", name: "Chargeable", categoryId: "led-candle" },
  { id: "various", name: "Various", categoryId: "led-candle" },
],
